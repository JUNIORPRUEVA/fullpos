...
const wchar_t* WindowClassRegistrar::GetWindowClass() {
  if (!class_registered_) {
    ...
    // If the Flutter view does not fully cover the window during startup/
    // resize, ensure the uncovered area is not rendered as white.
    window_class.hbrBackground = kBackgroundBrush;
