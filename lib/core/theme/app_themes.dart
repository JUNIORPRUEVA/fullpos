...
class AppThemes {
  ...
  static ThemeData get proPos => ThemeData(
    ...
    // Color scheme
    colorScheme: ColorScheme.fromSeed(
      seedColor: const Color(0xFF0D84FF), // Azul el̩ctrico premium
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(AppSizes.radiusM),
        borderSide: const BorderSide(color: Color(0xFF0D84FF), width: 2),
      ),
      errorBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(AppSizes.radiusM),
    ...
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: OutlinedButton.styleFrom(
        ...
        side: const BorderSide(color: Color(0xFF0D84FF), width: 1.5),
        minimumSize: const Size(0, 48),
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(AppSizes.radiusM),
        ),
