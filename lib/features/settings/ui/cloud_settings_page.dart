...
class _CloudSettingsPageState extends ConsumerState<CloudSettingsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Nube y sincronizacion'),
          actions: [
                  ...
                  child: ListView(
                    ...
                    children: [
                      SettingsLayout.sectionHeading(
                        context,
                        title: 'Sincronizacion y owner app',
                        subtitle:
                            'Configura la conectividad con nube, revisa colas de sincronizacion y diagnostica fallos de envio.',
                      ),
